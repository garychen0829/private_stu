...
public class FileProgressMonitor extends TimerTask implements SftpProgressMonitor {
    ...
    private long progressInterval = 5; // 默认间隔时间为5秒
    ...
    private void sendProgressMessage(long transfered) {
        if (fileSize != 0) {
            ...
            System.out.println("Current transfered: " + transfered + " bytes ===" + "Sending progress message: " + df.format(d) + "%");
        } else {
            System.out.println("Current transfered: " + transfered + " bytes ===" + "Sending progress message: " + transfered);
        }
    }
